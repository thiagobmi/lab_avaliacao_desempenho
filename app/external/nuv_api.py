...
def populate_nuv_api_wrapper(specifications: dict) -> None:
    ...
    NuvAPIWrapper.origin_username = specifications["api_specifications"][
        "origin_username"
    ]
    NuvAPIWrapper.origin_password = specifications["api_specifications"][
        "origin_password"
    ]
...
def get_camera_info_api(camera_id: int):
    return NuvAPIWrapper.run_request(
        method_name="get_camera", method_parameters={"camera_id": camera_id}
    )
